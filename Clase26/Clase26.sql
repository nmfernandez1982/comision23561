...
create table encabezo_facturas
(
id int auto_increment primary key, 
...
create table detalle_encabezo_facturas
(
id int auto_increment primary key, 
encabezo_facturas_id int not null,
...
alter table detalle_encabezo_facturas
add foreign key (encabezo_facturas_id)
references  encabezo_facturas(id);
